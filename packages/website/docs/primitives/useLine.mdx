...
import SimpleUseLine from "@site/src/components/docs/SimpleUseLine";
...
Among the configurations, only on of them is needed. If `vertices` are provided, it will **take precedence** over `length` _and ignore it_.
