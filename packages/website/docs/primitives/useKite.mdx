...
We're thinking of adding an `angle` config to define the elevating angle of shorter side against the x-axis _(horizontal line)_, but hold it because it may not make a great mathematical sense for creating a kite.
